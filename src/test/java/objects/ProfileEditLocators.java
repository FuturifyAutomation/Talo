...
public class ProfileEditLocators {
    ...
    @FindBy(xpath = ".//android.view.View[6]/android.widget.EditText[1]")
    public WebElement txt_BirthDay;

    @FindBy(xpath = ".//android.view.View[8]/android.widget.EditText[1]")
    public WebElement txt_Gender;

    @FindBy(xpath = ".//android.view.View[10]/android.widget.EditText[1]")
    public WebElement txt_PhoneNumber;

    @FindBy(xpath = ".//android.view.View[12]/android.widget.EditText[1]")
    ...
    public ProfileEditLocators(WebDriver driver){
        this.driver = driver;
    }
}
