...
public class Nexus_ProfileDetailsLocators {
    ...
    @FindBy(xpath = ".//android.view.ViewGroup[3]/android.widget.TextView[1]")
    public WebElement lbl_FullNameView;

    @FindBy(xpath = ".//android.view.ViewGroup[6]/android.widget.TextView[1]")
    public WebElement lbl_BirthDayView;

    @FindBy(xpath = ".//android.view.ViewGroup[9]/android.widget.TextView[1]")
    public WebElement lbl_GenderView;

    @FindBy(xpath = ".//android.view.ViewGroup[12]/android.widget.TextView[1]")
    public WebElement lbl_PhoneNumberView;

    @FindBy(xpath = ".//android.view.ViewGroup[14]/android.widget.TextView[1]")
    ...
    public Nexus_ProfileDetailsLocators(WebDriver driver){
        this.driver = driver;
    }
}