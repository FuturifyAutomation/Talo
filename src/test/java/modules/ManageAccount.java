...
public class ManageAccount extends BaseClass{

    LoginLocators LoginScreen;
    RegisterLocators RegisterScreen;
    VerifyPinLocators VerifyPinScreen;
    HomeLocators HomeScreen;
    ProfileDetailsLocators ProfileDetailsScreen;
    ProfileEditLocators ProfileEditScreen;
...
//      Instantiate Elements Locator class
        LoginScreen = PageFactory.initElements(driver, LoginLocators.class);
        RegisterScreen = PageFactory.initElements(driver, RegisterLocators.class);
        VerifyPinScreen = PageFactory.initElements(driver, VerifyPinLocators.class);
        HomeScreen = PageFactory.initElements(driver, HomeLocators.class);
        ProfileDetailsScreen = PageFactory.initElements(driver, ProfileDetailsLocators.class);
        ProfileEditScreen = PageFactory.initElements(driver, ProfileEditLocators.class);
    }
